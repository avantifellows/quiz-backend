    ...
    for quiz_index, quiz in enumerate(client.quiz.quizzes.find()):
        ...
        for question_set_index, question_set in enumerate(quiz["question_sets"]):
            ...
            if (
                ...
                if (
                    "questions" in question_set
                    and len(question_set["questions"]) > 0
                    and "marking_scheme" in question_set["questions"][0]
                ):
                    question_marking_scheme = question_set["questions"][0][
                        "marking_scheme"
                    ]
